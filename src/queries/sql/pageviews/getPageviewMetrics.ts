...
async function relationalQuery(
  ...
  if (column === 'referrer_domain') {
    excludeDomain = `and website_event.referrer_domain != 
      CASE WHEN substr(website_event.hostname, 1, 4) = 'www.' 
        THEN substr(website_event.hostname, 5) 
        ELSE website_event.hostname 
      END
